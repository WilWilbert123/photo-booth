...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col justify-between p-4 h-dvh sticky top-0 shrink-0">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex items-center justify-between px-2">
          ...
          >
            <div className="w-8 h-8 rounded-xl bg-zinc-900 dark:bg-white flex items-center justify-center text-white dark:text-zinc-900 group-hover:scale-105 transition-transform">
