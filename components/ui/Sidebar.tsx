      ...
      <aside className="hidden lg:flex w-64 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex-col justify-between p-4 h-dvh sticky top-0 shrink-0 select-none">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-medium transition-all ${
                    isActive
                      ? 'bg-blue-50 dark:bg-zinc-900 text-blue-600 dark:text-zinc-100 font-bold'
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="text-[11px] text-zinc-400 hover:text-zinc-700 dark:text-zinc-500 dark:hover:text-zinc-300 font-medium text-center transition-colors px-1 py-0.5 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-900"
          >
